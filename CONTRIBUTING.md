...
In an effort to not repeat bugs (and break less popular features), unit tests ware created. The goal of the tests are to be simple and to be placed in the `test` directory where it will be automatically run.
